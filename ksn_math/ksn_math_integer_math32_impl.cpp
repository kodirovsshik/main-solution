...
#pragma warning(disable : 4800)
		carry = _adc32(carry, (uint32_t)operand1, (uint32_t)operand2, (uint32_t*)&result);
		carry = _adc32(carry, ((uint32_t*)&operand1)[1], ((uint32_t*)&operand2)[1], ((uint32_t*)&result) + 1);
#pragma warning(pop)
...
#pragma warning(push)
#pragma warning(disable : 4800)
		carry = _sbb32(carry, (uint32_t)operand1, (uint32_t)operand2, (uint32_t*)&result);
		carry = _sbb32(carry, ((uint32_t*)&operand1)[1], ((uint32_t*)&operand2)[1], ((uint32_t*)&result) + 1);
#pragma warning(pop)
